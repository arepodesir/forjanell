...
var _tmpl$$1 = ["<div", ' class="', '">', "</div>"], _tmpl$2$1 = ["<div", ' class="text-line-wrapper overflow-hidden mb-1 flex justify-center flex-wrap" style="', '"><div class="text-line-content opacity-0 inline-block" style="', '">', "</div></div>"], _tmpl$3 = ["<span", ' class="word-item inline-block transition-all duration-300 hover:scale-125 hover:-translate-y-1 hover:text-[#00f3ff] active:scale-110 active:text-[#ff66c4] cursor-default select-none pointer-events-auto mr-1.5" style="', '">', "</span>"];
function PretextShift(props) {
  ...
  return ssr(_tmpl$$1, ssrHydrationKey(), `w-full text-center select-none pointer-events-auto ${escape(props.class || "", true)}`, escape(createComponent(For, {
    ...
    children: (line, idx) => ssr(_tmpl$2$1, ssrHydrationKey(), ssrStyleProperty("min-height:", `${escape(lh(), true)}px`) + ssrStyleProperty(";line-height:", `${escape(lh(), true)}px`) + ssrStyleProperty(";perspective:", "400px"), ssrStyleProperty("animation:", "textShiftIn 0.8s cubic-bezier(0.16, 1, 0.3, 1) forwards") + ssrStyleProperty(";animation-delay:", `${escape(props.delay || 0, true) + escape(idx, true) * 80}ms`) + ssrStyleProperty(";transform-origin:", "center bottom") + ssrStyleProperty(";will-change:", "transform, opacity"), escape(createComponent(For, {
      ...
      children: (word) => ssr(_tmpl$3, ssrHydrationKey(), ssrStyleProperty("font-family:", "inherit") + ssrStyleProperty(";text-shadow:", "0 2px 4px rgba(0,0,0,0.3)"), escape(word))
    })))
  })));
}
...
function MessageList(props) {
  return ssr(_tmpl$, ssrHydrationKey(), escape(createComponent(For, {
    ...
    })), ssrStyleProperty("font-family:", "'Caveat', cursive"), escape(msg.sender), ssrStyleProperty("font-family:", "'Comfortaa', sans-serif"), escape(msg.relation))
  })));
}
...
const $$Index = createComponent$1(($$result, $$props, $$slots) => {
  const MESSAGES = [
    ...
    },
    {
      ...
      text: "To the coolest Taurus I know: have a total blast! Keep shining bright and never stop being your fabulous, glittery self. Cheers to more adventures! 🥂",
      color: "border-aero-cyan shadow-aero-cyan/20",
      gradient: "from-cyan-500/20 to-blue-500/20"
    },
    {
      sender: "Clara 🦄",
      relation: "Soul Sister",
      text: "Janell, another year older, another year wiser, and another year of being completely iconic! Happy Birthday, gorgeous soul! 🎂🌸",
      color: "border-aero-magenta shadow-aero-magenta/20",
      gradient: "from-purple-500/20 to-pink-500/20"
    },
    {
      sender: "Dave 🚀",
      relation: "Tech Bro",
      text: "Sending you the biggest quantum holographic hug! May your day be filled with magic, code, coffee, and good vibes only. 💫",
      color: "border-aero-green shadow-aero-green/20",
...
</p> </div> ${renderComponent($$result3, "MessageList", MessageList, { "client:load": true, "messages": MESSAGES, "client:component-hydration": "load", "client:component-path": "/home/arepo/LOGOS/SOFTWARE/DOGMA/FORJANELL/CODE/web/src/components/MessageList/MessageList", "client:component-export": "default" })} ${renderScript($$result3, "/home/arepo/LOGOS/SOFTWARE/DOGMA/FORJANELL/CODE/web/src/pages/messages/index.astro?astro&type=script&index=0&lang.ts")} ` })} ` })}`;
