import{d as He,b as _,o as Le,g as r,e as y,i as n,m as h,c as p,f as A,r as ee,h as Pe,u as Oe,t as i,s as b,a as B,j as Ee,F as I}from"./web.CWjATOO3.js";import{h as te}from"./haptics.CX2_4n8b.js";function Y(o,j=30){const w=[];let k=0;for(const z of o)w.push({char:z,delay:k*j}),k++;return w}var Fe=i(`<div class="w-full h-full backdrop-blur-sm opacity-80 flex flex-col items-center justify-center gap-3"><div class="w-full flex items-center justify-center shrink-0"><div><div class=holo-card__inner><!$><!/><div class="absolute inset-0 bg-gradient-to-b opacity-50 from-blue-900/70 via-pink-900/50 to-indigo-900/80 rounded-2xl z-5"></div><div class="holo-card__glitter z-10"></div><div class="holo-card__shine z-10"></div><div class="holo-card__glare z-10"></div><div class="relative z-20 flex flex-col items-center text-center p-4 h-full"></div></div></div></div><style>
